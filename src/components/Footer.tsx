                ...
                <li className="mb-4 flex items-center">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M12 2.25c4.556 0 8.25 3.694 8.25 8.25 0 4.785-4.5 8.835-7.196 10.623a1.69 1.69 0 0 1-1.108.377c-.4 0-.794-.135-1.108-.377C8.25 19.335 3.75 15.285 3.75 10.5c0-4.556 3.694-8.25 8.25-8.25ZM12 12a1.875 1.875 0 1 0 0-3.75A1.875 1.875 0 0 0 12 12Z"
                    />
                  </svg>
                  <a href="https://flowbite.com/" className="hover:underline">
                    Av Juan B. Justo 7015 – (CABA)
                  </a>
                </li>
              </ul>
            </div>
